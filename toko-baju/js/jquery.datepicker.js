...
(function($) { // create private scope (inside you can use $ instead of jQuery)
    ...
    $.fn.simpleDatepicker = function(options) {
		...
		function closeIt (el, datepicker, dateObj) {
			...
			datepicker.fadeOut('fast');//remove();
			datepicker = null;
			jQuery.data(el.get(0), "simpleDatepicker", {hasDatepicker : false});
		}

                function flipDateAndMonth(dateString) {
			...
			if ( jQuery(this).is('input') && 'text' == jQuery(this).attr('type')) {
				...
				jQuery(this).click(function (ev) {
					...
					if (false == jQuery.data($this.get(0), "simpleDatepicker").hasDatepicker) {
						...
						var initialDate = flipDateAndMonth($this.val());
	...
	jQuery.fn.simpleDatepicker.formatOutput = function (dateObj) {
                ...
                var mnt = ((dateObj.getMonth() + 1) < 10) ? '0' + (dateObj.getMonth() + 1) : (dateObj.getMonth() + 1);

		return day + "/" + mnt + "/" + dateObj.getFullYear();
	};
