<?php
class Transaksi_kehilangan_model extends Model{

    function Transaksi_kehilangan_model(){
        parent::Model();
    ...
    function tambah_transaksi($id_produk, $jumlah)
    {
        ...
        if($q){
            $jumlah = -$jumlah;
            return $this->produk->tambah_stok_produk($id_produk,$jumlah,$x->harga_beli, "re");
        }
    }
