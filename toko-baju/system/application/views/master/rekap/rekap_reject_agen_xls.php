...
$objPHPExcel->getProperties()->setCreator("Manajemen Toko Baju")
                             ...
                             ->setTitle("Rekap Reject Agen")
                             ->setSubject("Rekap Reject Agen");

// header

$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A1:K1')->setCellValueByColumnAndRow(0, 1, "Rekap Reject Agen");
...
header('Content-Disposition: attachment;filename="rekap_reject_agen_' . time() . '.xls"');
