...
<div class="yellowbox">
    ...
    <form action="index.php/master/rekap/reject_agen_res" method="post" id="trx_form">
...
<div class="yellowbox" id="filterbox" style="display: none">
    <form action="index.php/master/produk/filter" method="post" id="filter_form">
        ...
        <table width="100%">
            <tr>
                <td>Kode agen:</td>
                <td><input type="text" id="agen" name="f_agen" size="20" value=""/></td>
            </tr>
            <tr>
                <td>Merek:</td>
    ...
    $('#agen').autocompleteArray("<?php foreach ($daftar_agen as $agen) echo $agen['kode'] . ";" ?>".split(";"), {autoFill:true, delay:10,selectFirst:true,selectOnly:true});
...
$('#filter_form').submit(function(){
    ...
    $('#rekap_result').slideUp('slow', function(){
        ...
        $('#rekap_result')
            .load('index.php/master/rekap/reject_agen_get',
            {
                ...
                var jumlahFilterAktif = 8 - $("#filter_form :input[value='']").length;
