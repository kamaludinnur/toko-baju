...
<form action="index.php/master/rekap/reject_konsumen_xls" method="post" style="float: right; margin-bottom: 10px">
...
<table class="rounded-corner sortable" id="main_table">
    ...
    <tfoot>
        <tr style="font-size: 15px;">
            <td colspan="9" style="text-align: right"><strong>Total refund</strong></td>
