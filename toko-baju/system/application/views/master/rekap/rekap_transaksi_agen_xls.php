...
$objPHPExcel->getProperties()->setCreator("Manajemen Toko Baju")
                             ...
                             ->setTitle("Rekap Transaksi Agen")
                             ->setSubject("Rekap Transaksi Agen");

// header

$objPHPExcel->setActiveSheetIndex(0)->mergeCells('A1:K1')->setCellValueByColumnAndRow(0, 1, "Rekap Transaksi Agen");
...
$objPHPExcel->getActiveSheet()
            ...
            ->setCellValueByColumnAndRow(10, 4, "Keuntungan");
...
$i = 5; foreach($data_rekapan as $data) :
    ...
    $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow(10, $i, $data['keuntungan']);
...
header('Content-Disposition: attachment;filename="rekap_transaksi_agen_' . time() . '.xls"');
