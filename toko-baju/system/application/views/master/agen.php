...
<div>
    ...
    <ul>
        ...
        <?php
        if($sort_by == 'id') echo "<strong>ID</strong> &middot; <a href='index.php/master/agen/manage/nama'>Nama</a>";
        if($sort_by == 'nama') echo "<a href='index.php/master/agen/manage'>ID</a> &middot; <strong>Nama</strong>";
        ?>
        </li>
        <li>
...
<table class="tabel_agen" id="main_table">
    <thead>
        <tr>
            <th width="25">ID</th>
    ...
    <tbody>
        ...
        <tr class="row<?php if($id_agen_baru == $agen['id']) echo ' entri_baru'; ?>" id="baris_<?php echo $agen['id'] ?>" >
            ...
            <td onclick="showEditForm(<?php echo $agen['id']; ?>)"><input type="button" value="Edit"/></td>
        </tr>
