...
<table class="tabel_ukuran" id="main_table">
    <thead>
        <tr>
            <th width="25">ID</th>
    ...
    <tbody>
        ...
        <tr class="row<?php if($id_ukuran_baru == $ukuran['id']) echo ' entri_baru'; ?>" id="baris_<?php echo $ukuran['id'] ?>" >
            ...
            <td onclick="showEditForm(<?php echo $ukuran['id']; ?>)"><input type="button" value="Edit"/></td>
        </tr>
